...
const DICT: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    'nav.sellers': 'Producteurs',
    'nav.favorites': 'Favoris',
    'nav.proArea': 'Espace pro',
    'sellers.title': 'Nos producteurs',
    'sellers.empty': 'Aucun producteur ne correspond à vos filtres.',
    'sellers.unavailable':
      "L'annuaire des producteurs n'a pas pu être chargé. Rafraîchissez la page dans un instant.",
    'sellers.filters.search': 'Rechercher',
    'sellers.filters.searchPlaceholder': 'Nom, ville…',
    'sellers.filters.country': 'Pays',
    'sellers.filters.region': 'Région',
    'sellers.filters.featuredOnly': 'Vedettes uniquement',
    'sellers.filters.sort': 'Tri',
    'sellers.sort.featured': "Vedettes d'abord",
    'sellers.sort.recent': 'Récents',
    'sellers.sort.nameAsc': 'Nom A→Z',
  ...
  en: {
    ...
    'sellers.title': 'Our sellers',
    'sellers.empty': 'No seller matches your filters.',
    'sellers.unavailable': 'The sellers directory is temporarily unavailable.',
    'sellers.filters.search': 'Search',
    'sellers.filters.searchPlaceholder': 'Name, city…',
    'sellers.filters.country': 'Country',
    'sellers.filters.region': 'Region',
    'sellers.filters.featuredOnly': 'Featured only',
    'sellers.filters.sort': 'Sort',
    'sellers.sort.featured': 'Featured first',
    'sellers.sort.recent': 'Recent',
    'sellers.sort.nameAsc': 'Name A→Z',
