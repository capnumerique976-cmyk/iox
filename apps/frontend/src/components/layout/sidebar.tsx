...
export function Sidebar() {
  ...
  // Les routes « racine » (/dashboard, /admin) doivent matcher exactement, sinon
  // « Tableau admin » resterait actif sur toutes les sous-routes /admin/*.
  ...
  return (
    <aside className="w-64 min-h-screen bg-white border-r border-gray-200/70 flex flex-col overflow-y-auto">
